...
public class E02_Send {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Pcap.send("\\Device\\NPF_{51306AE4-88CB-41EA-9B10-AA87F5C4076D}", new byte[] {       // ----- Ethernet
        ...
        Pcap.send("\\Device\\NPF_{51306AE4-88CB-41EA-9B10-AA87F5C4076D}", Convert.hex2bytes( // ----- Ethernet
